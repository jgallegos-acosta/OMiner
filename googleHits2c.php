<?php 
   ...
   $ttok = "pésima máquina";
   $term  = urlencode($ttok);
   $gQuery = '%22'.$term.'%22'.'+AROUND(10)+'.'%22'.urlencode('excelente').'%22';
   
   print $gQuery ;
   
   exit(0);
/*
$line="a_el_fin_y_a_el_cabo es";
   $tok1 = strtok($line, " \n\r");
   $tok2 = strtok(" \n\r");   
...
for ($i = $linecount; $i < $cbl; $i++)
{
   ...
   */
   ...
   //print $gQuery."\n";
   $gQuery = '%22'.$term.'%22'.'+AROUND(10)+'.'%22'.urlencode('mala').'%22';
