<?php
/*
   Módulo para extrar bigramas "negativos"
 */
/*
 $tag_path = './OpinionsTAG';
 $mfb_path = './OpinionsNGB';
...
*/
   ...
   $fname = "Indesit_WIN_101__Opinion_1440636.html.tag";
   $fname2 = "Indesit_WIN_101__Opinion_1440636.html.2g";
